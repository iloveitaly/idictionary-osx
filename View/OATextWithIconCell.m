...
- (void)drawInteriorWithFrame:(NSRect)aRect inView:(NSView *)controlView;
{
	...
	[[self icon] setFlipped:[controlView isFlipped]];
...
- (void)setObjectValue:(id <NSObject, NSCopying>)obj {
    if ([obj isKindOfClass:[NSString class]] || [obj isKindOfClass:[NSAttributedString class]]) {
        ...
        [super setObjectValue:[dictionary objectForKey:TITLE_KEY]];
        [self setIcon:[dictionary objectForKey:IMG_KEY]];
    }
}
